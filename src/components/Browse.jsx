...
const Browse = () => {
    ...
    useEffect(() => {
        setOgImg(ogImage);
        setOgTitle('Karasu');
        setOgDesc('Discover your favourite animanga titles, all conveniently available for your enjoyment on Karasu.')
    }, [])
  ...
  return (
    <main className='flex flex-col gap-6 pb-16 dark:text-white lg:gap-3'>
        ...
        <section className='relative text-white font-montserrat h-[30vh] bg-black sm:h-[35vh] lg:h-[70vh] lg:rounded-b-[50px] lg:overflow-hidden'>
            <h2 className='absolute top-5 left-5 font-bold z-[1] sm:text-lg sm:left-7 md:left-10 lg:left-16 lg:top-24 lg:text-base'></h2>
